...
namespace DTO_Data_Transfer_Object
{
    ...
    public partial class DinhThienTruong_DoAn1Entities1 : DbContext
    {
        public DinhThienTruong_DoAn1Entities1()
            : base("name=DinhThienTruong_DoAn1Entities1")
        {
        }
        ...
        public virtual DbSet<KhachHangThanhVien> KhachHangThanhViens { get; set; }
